...
//  echo "Movies/".$lnimg.$movie;
  echo "<button data=\"Movies/".$lnimg.$movie."\" target=_blank class=\"movies mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent\">".$movie."</button><br><br>";
} 
echo "</center>";
*/
?>
