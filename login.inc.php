...
<head>
	...
	<title>CinePhilia|A website built for movie buffs</title>
...
<div class="wrapper">
      ...
      <div class="container">
        ...
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
            ...
            <a class="navbar-brand" href="index.html">Cine<span class="themecolor">Philia</span></a>
        </div>
        ...
        <div class="container ">
            <div class="row">
                <div class="col-md-12 col-sm-12 animate fadeInDown">
                   <h1 class="text-capitalize">Welcome on <strong>Cine<span class="themecolor">Philia</span></strong></h1>
               <p class="lead mklrg">This is a platform built for those who love to <strong>watch movies</strong></p>
         ...
         <div class="row">
             <div class="col-md-6 col-sm-6">
               <div class="aboutText">
                        ...
                        <p class="mklrg">We love making your lifestyle easy and comfortable. Its a perfect place for Moviebuffs who love watching movies.</p>
                        <ul class="aboutList">
                            <li>
                            ...
                            <li>
                                <span class="fa fa-dot-circle-o"></span>
                                <strong>Clients</strong> - <em>We care for our clients</em>
                            </li>
                        </ul>
                    </div>  
 ...
 <div class="container">
     ...
     <div class="col-md-4 O-service">
                    ...
                    <h4><strong>Organize</strong></h4>
                    <p>Organize all your movie collection at one place.</p>
                </div>

                <div class="col-md-4 O-service">
                          <i class="material-icons">assessment</i>
                    <h4><strong>Suggest</strong></h4>
                    <p>Suggest you the best movie according to your convenience and choice.</p>
                </div>

                <div class="col-md-4 O-service">
                    <i class="material-icons">assignment</i>
                    <h4><strong>Connect</strong></h4>
                    <p>Share your movie collection and your opinion with your friends.</p>
                </div>
...
<form method="post" action="signup.php" enctype="multipart/form-data" class="mdl-grid">
            ...
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input" type ="text" name="proim" maxlength="100" id="locn">
    <label class="mdl-textfield__label" for="locn">Movies Location
  </label></div>
<br>
